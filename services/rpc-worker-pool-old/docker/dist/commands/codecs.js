...
exports.deserializeURI = exports.serializeURI = exports.decodeSanitizedURI = exports.sanitizeURI = void 0;
...
function decodeSanitizedURI(encodedURI) {
    return decodeURI(encodedURI);
}
exports.decodeSanitizedURI = decodeSanitizedURI;
function serializeURI(str) {
    return encodeURIComponent(str);
}
exports.serializeURI = serializeURI;
function deserializeURI(encodedURI) {
    return decodeURIComponent(encodedURI);
}
exports.deserializeURI = deserializeURI;
